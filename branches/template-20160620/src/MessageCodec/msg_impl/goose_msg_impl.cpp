...
///
///
void GooseMsgImpl::SetMacAddr(const uint8_t *desMac, const uint8_t *srcMac, size_t macLen)
{
	ETHER_II_HEADER ethhdr;
...
///
///
void GooseMsgImpl::Set8021QVlanInfo(uint8_t userPriority, uint16_t vlanID)
{
	IEEE802_1Q_VLAN_INFO info;
