...
QTableWidget* CGooseTxCBShowWidget::createCBTableWidget()
{
    const QString captionName[MAX_CB_COL_NUM] = {
        ...
        CGooseTxCBShowWidget::tr("MAC地址"),
        CGooseTxCBShowWidget::tr("通道数目"),
        CGooseTxCBShowWidget::tr("数据集描述"),
        CGooseTxCBShowWidget::tr("数据集地址"),
        CGooseTxCBShowWidget::tr("goID"),
        CGooseTxCBShowWidget::tr("gocbRef"),
        CGooseTxCBShowWidget::tr("VLAN-ID"),
        CGooseTxCBShowWidget::tr("VLAN-优先级"),
        CGooseTxCBShowWidget::tr("配置版本号")
    };
...
QTableWidget* CGooseTxCBShowWidget::createChnlTableWidget()
{
    const QString captionName[MAX_CHNL_COL_NUM] = {
        CGooseTxCBShowWidget::tr("序号"),
        CGooseTxCBShowWidget::tr("类型"),
        CGooseTxCBShowWidget::tr("LN描述"),
        CGooseTxCBShowWidget::tr("DO描述"),
        CGooseTxCBShowWidget::tr("DU描述"),
        CGooseTxCBShowWidget::tr("路径"),
    };
