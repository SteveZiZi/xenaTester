...
void CSmvTxCBShowWidget::addSmvCB(const SCDSMV92ANALYSIS_IEDSMV_INFO& smvCB)
{
    ...
    {
        if (m_checkedReport[i] == smvCB.smvAppID)
        {
            checked = true;
            break;
        }
...
QTableWidget* CSmvTxCBShowWidget::createCBTableWidget()
{
    const QString captionName[MAX_CB_COL_NUM] = {
        CSmvTxCBShowWidget::tr("Num"),
        CSmvTxCBShowWidget::tr("APPID"),
        CSmvTxCBShowWidget::tr("MAC"),
        CSmvTxCBShowWidget::tr("ChannelNum"),
        CSmvTxCBShowWidget::tr("DataDescribe"),
        CSmvTxCBShowWidget::tr("DataAddress"),
        CSmvTxCBShowWidget::tr("SvID"),
        CSmvTxCBShowWidget::tr("VLAN-ID"),
        CSmvTxCBShowWidget::tr("VLAN-Priority"),
        CSmvTxCBShowWidget::tr("Version")
    };
...
QTableWidget* CSmvTxCBShowWidget::createChnlTableWidget()
{
    const QString captionName[MAX_CHNL_COL_NUM] = {
        CSmvTxCBShowWidget::tr("Num"),
        CSmvTxCBShowWidget::tr("LN Description"),
        CSmvTxCBShowWidget::tr("DO Description"),
        CSmvTxCBShowWidget::tr("DU Description"),
        CSmvTxCBShowWidget::tr("Path"),
    };
