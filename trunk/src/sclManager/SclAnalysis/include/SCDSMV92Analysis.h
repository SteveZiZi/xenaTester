...
///     SCD文件SMV92配置解析接口
///
SCLMANAGER_API ISCDSMV92Analysis *CreateSCDSMV92AnalysisImpl( ISCLCacheManager *pSclCacheMgr );
...
///     objPtr - 指向接口对象实例的指针
///
SCLMANAGER_API void  RelaseSCDSMV92AnalysisImpl(ISCDSMV92Analysis *objPtr);
