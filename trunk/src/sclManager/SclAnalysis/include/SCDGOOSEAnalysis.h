...
///     SCD文件GOOSE配置解析接口
///
SCLMANAGER_API ISCDGOOSEAnalysis *CreateSCDGOOSEAnalysisImpl( ISCLCacheManager *pSclCacheMgr );
...
///     
///
SCLMANAGER_API void  RelaseSCDGOOSEAnalysisImpl(ISCDGOOSEAnalysis *objPtr);
