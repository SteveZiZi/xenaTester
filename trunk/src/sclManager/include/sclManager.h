...
#include "..\SclAnalysis\include\sclanalysis.h"
#include "..\SclAnalysis\include\ISCLCacheManager.h"
#include "..\SclAnalysis\include\SCDGOOSEAnalysis.h"
#include "..\SclAnalysis\include\SCDSMV92Analysis.h"



// 此类是从 sclManager.dll 导出的
class SCLMANAGER_API CSCLManager {
public:
private:
    CSCLManager(void);
    ~CSCLManager(void);
...
public:
    ...
    ///     0 - 操作成功； -1 - 操作失败
    ///
    int Load(const std::wstring &strFileName, bool bForce = false);
    ...
    ISCDGOOSEAnalysis* GetGooseAnalysis() {return m_pGooseAnalysis;}
    ISCDSMV92Analysis* GetSmv92Analysis() {return m_pSmv92Analysis;}
